...
class DefinitionGenerator:
    ...
    def wait_for_run_completion(self, thread_id, run_id):
        ...
        TLDR:
            ...
            it retrieves the response and writes it to the nursery rhyme file path.
        #######################################################################
            ...
            Postconditions:
            - The method waits until the specified run is completed and then writes the
              nursery rhyme generated by the assistant to the file path determined by
              'self.nursery_rhyme_filepath'.

            Side effects:
            - Periodically sends requests to the OpenAI API, potentially consuming API
              quota.
            - Writes the generated nursery rhyme to a file, which may overwrite existing
              content.
        ...
        while True:
            try:
                ...
                if run.completed_at:
                    ...
                    # Write the response to the nursery rhyme file path
                    return response
                    break
